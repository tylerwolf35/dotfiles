...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- Screenshot
    , ((modm .|. shiftMask,   xK_s), spawn "maim -s /home/tyler/Pictures/$(date +%F_%H%M%S).png")

    -- close focused window
    , ((modm .|. shiftMask, xK_q     ), kill)

     -- Rotate through the available layout algorithms
    , ((modm,               xK_Right ), sendMessage NextLayout)
    ...
    -- Quit xmonad
    , ((modm .|. shiftMask, xK_p     ), spawn "/home/tyler/.config/rofi/powermenu/type-1/powermenu.sh")
